...
public class EditProfileLawyerActivity extends BaseActivity {
  ...
  protected void onCreate(@Nullable Bundle savedInstanceState) {
    ...
    setContentView(R.layout.activity_profile_edit_lawyer);
  ...
  private void startCamera() {
    PermissionHelper.requestPermissions(
        ...
        () -> {
          EasyImage.openCamera(EditProfileLawyerActivity.this, Constants.IMAGE_TYPE);
        },
        ...
        new DefaultCallback() {
          ...
          public void onImagePicked(File imageFile, EasyImage.ImageSource source, int type) {
            ...
            CropImage.activity(uri)
                ...
                .start(EditProfileLawyerActivity.this);
          }
          ...
          public void onCanceled(EasyImage.ImageSource source, int type) {
            if (source == EasyImage.ImageSource.CAMERA) {
              File photoFile =
                  EasyImage.lastlyTakenButCanceledPhoto(EditProfileLawyerActivity.this);
              if (photoFile != null) {
                photoFile.delete();
              }
            }
