...
public class JudgeChooseSectionFragment extends BaseFragment {
  public static final String TAG = "JudgeChooseSectionFragment";
  @Inject Prefs mPrefs;
  ...
  public static JudgeChooseSectionFragment newInstance() {
    return new JudgeChooseSectionFragment();
  }
  ...
  public View onCreateView(
    ...
    View view =
        bindView(inflater.inflate(R.layout.fragment_judges_choose_section, container, false));
    return view;
  }
