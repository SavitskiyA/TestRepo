...
public class SignUpListActivity extends BaseActivity implements OnButtonEnableListener {
  ...
  public static void startForResult(Activity activity, String title, String[] categories, boolean[] choosenCategoriesBoolean, int requestCode) {
  ...
  @OnClick(R.id.ok)
  public void onClick() {
    String choosenCategories = StringUtils.getStringFromList(mAdapter.getChoosenCategoriesList(), StringUtils.DOT_COMMA_SPACE);
    boolean[] choosenCategoriesBooleans = mAdapter.getChoosenCategoriesBooleans();
    JudgeSignUpActivity.sendActivityResult(this, choosenCategories, choosenCategoriesBooleans);
  }
